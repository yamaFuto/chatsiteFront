    ...
    <div className="flex items-center bg-gray-300 py-6 flex-wrap">
      ...
      <div className="flex">
        ...
        <button onClick={sendTheme}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="hover:bg-gray-500 rounded w-10 h-10 p-2 mx-2">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-10 h-10 mr-6">
