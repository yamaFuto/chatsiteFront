...
const Header: React.FC = () => {
  ...
  return (
    ...
    <div className="flex items-center bg-gray-300 py-6 flex-wrap">
      <Link href="/">
      <div className="text-5xl mx-10 mr-32 pb-3 bg-amber-300 rounded-lg border-r-4">Logo</div>
      </Link>
      ...
      <button onClick={onClick} className="bg-yellow-100 px-2 rounded-md mr-10">make Thread</button>
